...
console.log(fix("")) // return ""
console.log(fix("hi.")) // return "Hi."
console.log(fix("hello. my name is inigo montoya. you killed my father. prepare to die.")) // return "Hello. My name is inigo montoya. You killed my father. Prepare to die."

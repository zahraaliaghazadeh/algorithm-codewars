...
console.log(isValid([1,3,7])) // returns true
console.log(isValid([7,1,2,3])) // returns false
console.log(isValid([1,3,5,7])) // returns false
console.log(isValid([1,5,6,7,3])) // returns true
console.log(isValid([5,6,7])) // returns true

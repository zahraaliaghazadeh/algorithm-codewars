...
console.log(sortByLength(["Beg", "Life", "I", "To"]));             // returns ["I", "To", "Beg", "Life"]
console.log(sortByLength(["", "Moderately", "Brains", "Pizza"]));  // returns ["", "Pizza", "Brains", "Moderately"]
console.log(sortByLength(["Longer", "Longest", "Short"]));         // returns ["Short", "Longer", "Longest"]

...
function cost (mins) { 
  return 30 + (mins > 65 ? Math.ceil((mins - 65) / 30) * 10 : 0);
} 

console.log(cost(45))   // returns 30
console.log(cost(63))   // returns 30
console.log(cost(84))   // returns 40
console.log(cost(102))  // returns 50
console.log(cost(273))  // returns 100
